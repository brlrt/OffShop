...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">NoVolume Shop</a>
            </div>
    ...
    <div>
        ...
        <div>
            Insert Item<br>
            <form action="shop.php" method="GET">
            <input type="text" placeholder="idItem" name="idItem"></input> <br>
            <input type="text" placeholder="nameItem" name="nameItem"></input> <br>
            <input type="text" placeholder="preisItem" name="preisItem"></input> <br>
